 ...
 */
public class KafkaTableFactory2 implements TableFactory<KafkaStreamTable2> {
  public KafkaTableFactory2() {
  }

  @Override public KafkaStreamTable2 create(SchemaPlus schema,
      String name,
    ...
    return new KafkaStreamTable2(tableOptionBuilder);
  }
}
